...
export const ACTIVITY: Activity[] = [
  ...
  { id: 'a4', who: 'Kevin Enz', initials: 'KE', action: 'performed', tail: 'flight', when: 'Jul 14', flight: { code: '2NTG4H', level: 'nominal', label: 'Healthy' }, tab: 'Flights' },
  ...
  { id: 'a8', who: 'Kevin Enz', initials: 'KE', action: 'performed', tail: 'flight', when: 'Jan 9', flight: { code: '7QBH2M', level: 'caution', label: 'Review' }, tab: 'Flights' },
  ...
  { id: 'a11', who: 'Wei Chen', initials: 'WC', action: 'performed', tail: 'flight', when: 'Dec 15', flight: { code: 'X4KD91', level: 'nominal', label: 'Healthy' }, tab: 'Flights' },
