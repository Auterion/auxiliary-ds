      ...
      '/templates/': [
        {
          ...
          items: [
            ...
            { text: 'Mission planning', link: '/templates/mission-planning' },
            { text: 'Fleet overview', link: '/templates/fleet-overview' },
            { text: 'Post-flight review', link: '/templates/post-flight' },
          ],
        },
      ],
      '/data-viz/': [
