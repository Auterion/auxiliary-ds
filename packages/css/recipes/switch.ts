...
export const switchControl = tv({
  slots: {
    root: 'relative inline-flex h-5 w-9 shrink-0 items-center rounded-full border border-input bg-input outline-none data-[state=checked]:bg-primary data-[state=checked]:border-primary focus-visible:ring-2 ring-ring disabled:opacity-50 disabled:cursor-not-allowed transition-colors',
