...
export const dropdownMenu = tv({
  slots: {
    ...
    item: 'flex h-(--component-dropdown-menu-item-height) cursor-pointer select-none items-center truncate rounded-(--component-dropdown-menu-item-radius) px-(--component-dropdown-menu-item-padding-x) text-sm outline-none data-[highlighted]:bg-primary data-[highlighted]:text-primary-foreground data-[disabled]:opacity-(--opacity-disabled) data-[disabled]:cursor-not-allowed',
    label:
